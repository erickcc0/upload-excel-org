...
export function EmployeesTree({ data }: { data: Register[] }) {
  ...
  return (
    ...
    <div className="inline-block relative w-64 p-5"  >
        <select className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" onChange={onSelectMonth} value={month} defaultValue={0}>
    ...
    <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
      ...
      <div /* ref={printRef} */>
        {month && (
          ...
          label={<div className='p-2'>{formatter.format(new Date(`${month}/12/2012`))}</div>}
      ...
      <button className="p-4 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-green py-2 px-4 border border-blue-500 hover:border-transparent rounded" onClick={print}>
        Imprimir
      </button>
    </>
  );
